...
HD_PWD='E:/VivadoProjects/fullAdder/fullAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bitFullSubtractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitFullSubtractor.tcl -notrace
