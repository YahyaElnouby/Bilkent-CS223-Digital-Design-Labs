...
HD_PWD='E:/VivadoProjects/fullAdder/fullAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bitFullSubtractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bitFullSubtractor.tcl
