...
HD_PWD='E:/VivadoProjects/structuralBitAdder/structuralBitAdder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdderS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fullAdderS.tcl -notrace
