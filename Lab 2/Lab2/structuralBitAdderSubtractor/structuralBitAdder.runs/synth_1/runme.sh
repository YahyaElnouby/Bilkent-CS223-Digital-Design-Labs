...
HD_PWD='E:/VivadoProjects/structuralBitAdder/structuralBitAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fullAdderS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fullAdderS.tcl
