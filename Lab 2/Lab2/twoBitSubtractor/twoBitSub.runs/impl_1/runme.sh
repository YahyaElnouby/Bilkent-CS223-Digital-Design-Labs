...
HD_PWD='E:/VivadoProjects/Lab2/twoBitSubtractor/twoBitSub.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log twoBitSub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source twoBitSub.tcl -notrace
