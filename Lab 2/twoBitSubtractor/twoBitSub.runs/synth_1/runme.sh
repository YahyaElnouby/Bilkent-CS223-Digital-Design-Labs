...
HD_PWD='E:/VivadoProjects/Lab2/twoBitSubtractor/twoBitSub.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log twoBitSub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source twoBitSub.tcl
