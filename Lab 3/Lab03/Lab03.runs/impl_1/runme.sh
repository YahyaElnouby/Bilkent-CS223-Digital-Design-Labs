...
HD_PWD='E:/VivadoProjects/Lab03/Lab03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log functionMux.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source functionMux.tcl -notrace
