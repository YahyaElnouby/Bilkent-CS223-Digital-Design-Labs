...
HD_PWD='E:/VivadoProjects/Lab03/Lab03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log functionMux.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source functionMux.tcl
