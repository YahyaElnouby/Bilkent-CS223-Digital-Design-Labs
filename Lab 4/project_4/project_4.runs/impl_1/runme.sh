...
HD_PWD='E:/VivadoProjects/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log StepMotorInterface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source StepMotorInterface.tcl -notrace
