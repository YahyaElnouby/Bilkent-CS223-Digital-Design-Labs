...
HD_PWD='E:/VivadoProjects/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StepMotorInterface.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StepMotorInterface.tcl
